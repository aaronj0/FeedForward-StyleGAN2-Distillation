...
def generate_stats_from_log(line_interval=10, nb_data=2002, enforce_last_line=True):
    """
    Generate chart with all losses from log file generated by CycleGAN/Pix2pix/CUT framework
    """
    #extract every lines
    with open("C:/Users/MaximusX/CSE/ML-image-gen/StyleGan/Feedforward Manipulation Pipeline/weights/loss_log.txt", 'r') as f:
        lines = f.readlines()
        print(lines)
    ...
    plt.legend(loc="best")
    plt.show()
generate_stats_from_log(line_interval=10, nb_data=10800, enforce_last_line=True)